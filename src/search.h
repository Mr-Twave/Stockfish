...
struct SharedState {
    ...
    // The generation counter is now shared at this level
...
class Worker {
   ...
   private:
    ...
    // Now templated on policies for the policy-based design
...
#ifdef USE_NUMA_TT
    // Pointers to this worker's assigned TTs
...
#endif  // #ifndef SEARCH_H_INCLUDED# Makefile
